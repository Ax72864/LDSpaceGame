...
- Click a frame to open the build menu; click a facility option twice to place mining or turret.
- Click empty space to move the station toward the cursor.
- Move near gray asteroids so active mining stations produce metal.
- Build a second facility to trigger the enemy wave; turrets auto-fire.

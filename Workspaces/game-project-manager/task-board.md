...
| REL-001 | 发布 v0.1.0-prototype | PM + it-engineer | 待办 | QA-001 + GAME-004 | tag + Releases 目录 |
...
- [ ] 无 Guard 日志/PID 等无关文件进入提交
- [ ] 功能按阶段 A 验收通过
- [ ] Git tag `v0.1.0-prototype`（完整 v0.1 后）
- [ ] `Releases/v0.1.0-prototype/` 含可运行构建与版本说明
